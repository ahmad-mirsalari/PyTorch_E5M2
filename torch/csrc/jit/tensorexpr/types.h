...
AT_FORALL_SCALAR_TYPES_AND4(Bool, Half, BFloat16, Float8, NNC_DTYPE_DECLARATION)
//Ahmad
...
AT_FORALL_SCALAR_TYPES_AND4(Bool, Half, BFloat16, Float8, NNC_TODTYPE_DECLARATION)
//Ahmad
