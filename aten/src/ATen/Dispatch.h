...
#define AT_DISPATCH_CASE_FLOATING_TYPES_AND_HALF_FLOAT8(...)   \
  AT_DISPATCH_CASE(at::ScalarType::Double, __VA_ARGS__) \
  AT_DISPATCH_CASE(at::ScalarType::Float, __VA_ARGS__)  \
  AT_DISPATCH_CASE(at::ScalarType::Half, __VA_ARGS__)  \
  AT_DISPATCH_CASE(at::ScalarType::Float8, __VA_ARGS__) 


#define AT_DISPATCH_FLOATING_TYPES_AND_HALF_FLOAT8(TYPE, NAME, ...) \
  AT_DISPATCH_SWITCH(                                        \
      TYPE, NAME, AT_DISPATCH_CASE_FLOATING_TYPES_AND_HALF_FLOAT8(__VA_ARGS__))
...
#define AT_DISPATCH_CASE_FLOATING_TYPES_AND4(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, SCALARTYPE4, ...)  \
  AT_DISPATCH_CASE_FLOATING_TYPES(__VA_ARGS__)                                            \
  AT_DISPATCH_CASE(SCALARTYPE1, __VA_ARGS__)                                              \
  AT_DISPATCH_CASE(SCALARTYPE2, __VA_ARGS__)                                              \
  AT_DISPATCH_CASE(SCALARTYPE3, __VA_ARGS__)                                              \
...
#define AT_DISPATCH_COMPLEX_TYPES_AND2(SCALARTYPE1,SCALARTYPE2, TYPE, NAME, ...) \
  AT_DISPATCH_SWITCH(                                              \
      TYPE, NAME, AT_DISPATCH_CASE_COMPLEX_TYPES_AND2(SCALARTYPE1,SCALARTYPE2, __VA_ARGS__))
...
#define AT_DISPATCH_CASE_ALL_TYPES_AND6(                    \
